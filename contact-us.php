...
{  
        ...
        {  
            $name_error = "style='border: 1px solid #d64541;'";  
        }  
        else  
        {  
        ...
        {  
            $email_error = "style='border: 1px solid #d64541;'";
        }  
        else  
        {  
        ...
        {  
            $phone_error = "style='border: 1px solid #d64541;'";  
        }  
        else  
        {  
        ...
        {  
            $subject_error = "style='border: 1px solid #d64541;'";  
        } 
        if(empty($_POST["yourmessage"]))  
        {  
            $message_error = "style='border: 1px solid #d64541;'";  
        } 
        ...
        {  
            ...
            $sql = $conn->prepare("INSERT INTO customer_details VALUES (?, ?, ?, ?, ?, ?)");
            $sql->bind_param("sssiss",$sup_name, $sup_company, $sup_email, $sup_phone, $sup_subject, $sup_message);
            $sql->execute();
...
<div class="contact-form-cont" id="contact-form-id">
    <div class="form-item-1">
    <form method="POST" class="newsletter-form" name="newsletterForm" id="newsletter-id" onsubmit="return validateForm(document.newsletterForm.youremail2)" action="#contact-form-id">
        <div class="name-email-cont2">
            <div class="name-email-item2">
                <label for="yourname2" class="required">Your Name</label><br>
                <input type="text" id="yourname2" <?php echo $name_error; ?> name="yourname2" value="<?php echo isset($_POST["yourname2"]) ? $_POST["yourname2"] : ''; ?>"><br>
            </div>
            <div class="name-email-item2">
                <label for="yourcompany">Company Name</label><br>
                <input type="text" id="yourcompany" name="yourcompany" value="<?php echo isset($_POST["yourcompany"]) ? $_POST["yourcompany"] : ''; ?>"><br>
            </div>
            <div class="name-email-item2">
                <label for="youremail2" class="required">Your Email</label><br>
                <input type="text" id="youremail2" <?php echo $email_error; ?> name="youremail2" value="<?php echo isset($_POST["youremail2"]) ? $_POST["youremail2"] : ''; ?>"><br>
            </div>
            <div class="name-email-item2">
                <label for="yourtelephone" class="required">Your Telephone Number</label><br>
                <input type="text" id="yourtelephone" <?php echo $phone_error; ?> name="yourtelephone" value="<?php echo isset($_POST["yourtelephone"]) ? $_POST["yourtelephone"] : ''; ?>"><br>
            </div>
            <div class="name-email-item2">
                <label for="yoursubject" class="required">Subject</label><br>
                <input type="text" id="yoursubject" <?php echo $subject_error; ?> name="yoursubject" value="<?php echo isset($_POST["yoursubject"]) ? $_POST["yoursubject"] : ''; ?>"><br>
            </div>
            <div class="name-email-item2">
...
>>>>>>> 1025cdcb92a20b28fc91f5b3c3799e371ab96c04
</html>